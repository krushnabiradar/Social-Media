      ...
      <Auth>
        <div className="bg-white border flex flex-col gap-2 p-4 pt-10">
          <img
            ...
            src="https://thumbs.dreamstime.com/z/social-media-icons-d-facebook-instagram-whatsapp-twitter-vector-set-ai-illustrations-social-media-icons-d-facebook-instagram-146604422.jpg"
            alt=""
          />
          <form
